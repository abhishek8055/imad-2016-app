            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-3">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href = "../tech">Tech Talks</a></li>
                        <li><a href="../im">Imex</a></li>
                        <li><a href = "../bp" >BIET Profile</a></li>
                    </ul>
					
                    <ul class="nav navbar-nav navbar-right" style="margin-right:10px">
                        <li>
						    <a data-toggle="modal" data-target="#sugmodal"><span class="glyphicon glyphicon-edit"></span>&nbsp;Suggestions
						    </a>
						</li>
                        <li>
						    <a href= "#contact"><span class="glyphicon glyphicon-phone-alt"></span>&nbsp;Contact Us</a>
						</li>
                    </ul>
                </div>
            </div>
...
<!-- nav section end-->
    ...
    <div class="container-fluid" id="section1">
        <div class="row" id="section1row1">
	        <div class="col-md-12">
		        <br><br><br><p  id="para1">Generate Disseminate Preserve</p><br>	            
		    </div>
	    </div>
		...
		<div class="col-md-12" align="center">
            ...
            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#blogmodal" id="myBtn" >Post your !dea</button>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="padding:35px 50px;">
                            ...
                            <h6><span class="glyphicon glyphicon-envelope"></span>&nbsp;Post your idea/query </h6>
                        </div>
    ...
    <div class="container-fluid" id="section2">
        <div class="row" id="section2row1">       
		    <div class="col-md-12" id="section2row1">	        
			    <h2 id="section2heading">Recent Posts</h2>				
		    </div>
	    </div>
	</div>	
	...
	<div class="container">	
		...
		<?php 
		 $sql="SELECT * FROM daily_blogs ORDER BY id DESC LIMIT 12 ";
		 ...
		 if ($sql_res->num_rows > 0) {
                ...
                $b_id = $sql_row["id"];
				?>
		    <div class="col-xs-12 col-md-4" id="blog1" align="center"> 
			    <div class="panel panel-default">
				    <div class="panel-heading"><b><?php echo $name ?></b></div>
					<div class="panel-body"><?php echo $blog ?></div>
				    <div class="panel-footer">
					    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#resmodal" id="myBtn" >Respond</button>&nbsp;&nbsp;&nbsp;
				        <b><a class="btn btn-sm btn-success" href="responses.php?id=<?php echo $b_id ?>">Responses</a></b>
				    </div>
				</div>	
			</div>		
...
<ins class="adsbygoogle"
     ...
     data-ad-client="ca-pub-6444329620856233"
     data-ad-slot="5599384507"></ins>
<script>
...
<div class="row">
    ...
    <div class="col-md-2">
        ...
        <div><h4><a href="../tech"  style="color:teal">Tech Talks</a></h4></div>
    </div>
...
<div class="row" align="center" style="margin-top:2px">
    <div class="col-md-12">
        <a href="tnc.html" style="color:whitesmoke"><b>Terms & Conditions</b></a>
    </div>
</div>
</div>
<!--footer ends-->
...
<div class="row">
    ...
    <div class="col-xs-12" align="center" style="color:grey">
        <h1 id="contact">Contact Us</h1>
        <b><span class="glyphicon glyphicon-envelope"></span>&nbsp;support@odigos.in</b><br>
        <b> <span class="glyphicon glyphicon-phone"></span>&nbsp;(+91) 9452056704</b><br>
        <b> <span class="glyphicon glyphicon-phone"></span>&nbsp;(+91) 9458042329</b><br>
        <b> <span class="glyphicon glyphicon-phone"></span>&nbsp;(+91) 9675773252</b>
    </div>
            ...
            <div class="modal fade" id="resmodal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="padding:35px 50px;">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h6><span class="glyphicon glyphicon-envelope"></span>&nbsp;Post your response</h6>
                        </div>
                        <div class="modal-body" style="padding:40px 50px;">      
                            <form role="form" method="POST" action="res_post.php">
                                <div class="form-group" align="left">
                                    <label for="username"><span class="glyphicon glyphicon-user"></span>&nbsp;Name/Nick Name</label>
                                    <input type="text" name="user" class="form-control" id="username" placeholder="Enter your name" required> 
									<input  type ="hidden"  name  = "r_id"   value  = "<?php  echo $b_id ?>" >
                                </div>
                                <div class="form-group" align="left">
                                    <label for="comment"><span class="glyphicon glyphicon-comment"></span>
								        &nbsp;Type here
                                ...
                                <button type="submit" name="postq" class="btn btn-success btn-block">
				                    <span class="glyphicon glyphicon-flag"></span>Post
				                </button>
                            </form>						
                        </div>
